--[[
    Commissioned and made by xMee
    Optimized and cleaned by Makkara#1574/Phoenix
    
    This ui is from 2018/2019, I wouldn't recommend using it in your projects. If you do, please give credit
]]--
...
do
    ...
    function tabs:dropdown(name, useToggles, options, callback)
		...
		if type(options.list) == 'function' then
			list = options.list()
		end
        ...
        local function makeList()
            ...
            for i,v in pairs(list) do
                ...
                table.insert(instances, listItem)
